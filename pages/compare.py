    ...
    if run:
        if start_date < end_date:
            st.success(
                ...
                % (start_date, symptom_dateStart, symptom_dateFinish, end_date)
            )
        ...
        for i in range(rows):
            ...
            for j in range(cols):
                ...
                if i == 0:
                    ...
                    df = pd.DataFrame(
                        [[date_strf, "02:08:15", randint(60, 61), 0]],
                ...
                #
                if (
                    i <= days_betweenstarttolast.days
                    ...
                    continue
                if (
                    i <= days_betweenstarttofirst.days
                    or i >= days_betweenstarttolast.days
                ):
                    df3 = pd.DataFrame(
                        [[date_strf, "02:08:15", randint(60, 61), 0]],
                        columns=["Start_Date", "Start_Time", "Heartrate", "Risk"],
