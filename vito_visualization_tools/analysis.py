...
def analysis():
    ...
    choice = st.selectbox("Data to Analyze", ["Heart Rate", "Respiration Rate", "Heart Rate Varability"])
    st.caption("Data was collected from Andreas Ink, the lead of Vito, who began showing symptoms of a non-covid respiratory illness (tested negitive for Covid-19 twice) on week 12.  This is by no means formal data, simply an interesting statistic.")
